...
text1=pygame.font.Font("/usr/share/fonts/truetype/wqy/wqy-zenhei.ttc",20)
screen.fill(Brack)
class Bottles(object):
    def Icon_a(num,x,y,a):   #五罐
...
if __name__ == '__main__':
    while True:
        pygame.draw.rect(screen,Red,[size0*3+50,size0+110,size0*2-60,100],2)
        pygame.draw.rect(screen,Red,[size0*3+50,size0*2+25,size0*2-60,100],2)
        ...
        list=[[0,size0*3+85,350,'粉体顶料'],[1,size0*3+85,470,'粉体底料'],[2,size0*4+80,350,'磨料顶料'],[3,size0*4+80,470,'磨料底料'],[4,size0*5+40,350,'   暂 停'],[5,size0*5+40,470,'   停 止']]
        list0=[[0,size0*3-50,550,'计划配料份数:'],[1,size0*4-50,550,'已完成配料数量:'],[2,size0*5-30,550,'   修改系数:']]
        for k in list0:
