...
if __name__ == '__main__':
    while True:
        pygame.draw.rect(screen,Red,[size0*3+50,315,size0+150,100],2)
        pygame.draw.rect(screen,Red,[size0*3+50,435,size0+150,100],2)
        ...
        list=[[0,size0*3+80,350,'FT_lifter'],[1,size0*3+80,470,'FT_base'],[2,size0*4+80,350,'ML_lifter'],[3,size0*4+80,470,'ML_base'],[4,size0*5+80,350,'   PAUSE'],[5,size0*5+80,470,'   STOP']]
        list0=[[0,size0*3,550,'JHPLFS:'],[1,size0*4,550,'YWCPLSL:'],[2,size0*5,550,'   XGXS:']]
        for k in list0:
