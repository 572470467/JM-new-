...
line_a0=['http://192.168.10.200:80/feeder/0/0','http://192.168.10.200:80/feeder/1/0','http://192.168.10.200:80/feeder/2/0','http://192.168.10.200:80/feeder/3/0','192.168.10.200:80/feeder/4/0']
line_a1=['http://192.168.10.200:80/feeder/0/1','http://192.168.10.200:80/feeder/1/1','http://192.168.10.200:80/feeder/2/1','http://192.168.10.200:80/feeder/3/1','192.168.10.200:80/feeder/4/1']
line_b0=['http://192.168.10.201:80/feeder/0/0','http://192.168.10.201:80/feeder/1/0','http://192.168.10.201:80/feeder/2/0','http://192.168.10.201:80/feeder/3/0']
line_b1=['http://192.168.10.201:80/feeder/0/1','http://192.168.10.201:80/feeder/1/1','http://192.168.10.201:80/feeder/2/1','http://192.168.10.201:80/feeder/3/1']
Brack=[0,0,0]
White=[255,255,255]
...
if __name__ == '__main__':
    while True:
                ...
                for index in range(len(pressed_array)):
                    if pressed_array[index]:
                        ...
                        if size0+70<=pos[0]<=size0+160 and 490<=pos[1]<=580:
                            if index == 0:
                                response4=urllib.request.urlopen("http://192.168.10.119:80/feederon/a")
                                html4=response4.read()
                                text4=json.loads(html4)
                                print(text4['status'])
                            elif index==2:
                                response5=urllib.request.urlopen("http://192.168.10.119:80/feederoff/a")
                                html5=response5.read()
                                text5=json.loads(html5)
                                print(text5['status'])
                        elif size0*6+70<=pos[0]<=size0*6+160 and 490<=pos[1]<=580:
                            if index == 0:
                                response6=urllib.request.urlopen("http://192.168.10.119:80/feederon/b")
                                html6=response6.read()
                                text6=json.loads(html6)
                                print(text6['status'])
                            elif index==2:
                                response7=urllib.request.urlopen("http://192.168.10.119:80/feederoff/b")
        ...
        response10=urllib.request.urlopen("http://192.168.10.119:80/scale/a")
        html10=response10.read()
        response11=urllib.request.urlopen("http://192.168.10.119:80/scale/b")
