...
line_a0=['http://192.168.10.200:80/feeder/0/0','http://192.168.10.200:80/feeder/1/0','http://192.168.10.200:80/feeder/2/0','http://192.168.10.200:80/feeder/3/0','http://192.168.10.200:80/feeder/4/0']
line_a1=['http://192.168.10.200:80/feeder/0/1','http://192.168.10.200:80/feeder/1/1','http://192.168.10.200:80/feeder/2/1','http://192.168.10.200:80/feeder/3/1','http://192.168.10.200:80/feeder/4/1']
...
if __name__ == '__main__':
    while True:
                    ...
                    if pressed_array[index]:
                        for t in list:
                            if t[1]<=pos[0]<=t[1]+82 and t[2]<=pos[1]<=t[2]+35 and color0[t[0]]!=Gray:
                                if color0[t[0]]==Green:
                                    color0[t[0]]=Red
                                    if t[3]=='粉体顶料' or t[3]=='粉体底料':
                                        num=0
                                        Bottles.State(num)
                                    elif t[3]=='磨料顶料' or t[3]=='磨料底料':
                                        num=1
                                        Bottles.State(num)
                                    elif t[3]=='粉体顶料' or t[3]=='磨料顶料':
                                        color0[1]=Gray
                                        color0[3]=Gray
                                    elif t[3]=='粉体底料' or t[3]=='磨料底料':
                                        color0[0]=Gray
                                        color0[2]=Gray
                                elif color0[t[0]]==Red:
                                    color0[t[0]]=Green
        ...
        response11=urllib.request.urlopen("http://192.168.10.201:80/scale")
